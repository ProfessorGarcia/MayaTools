...
class UIW3DRedshiftHelper(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        custom_settings_fields_layout.addRow("Combined:", self.combined_depth_input)
        custom_settings_fields_layout.addRow("Global Illumination:", self.num_gi_bounces_input)
        custom_settings_fields_layout.addRow("Reflection:", self.reflection_depth_input)
        custom_settings_fields_layout.addRow("Refraction:", self.refraction_depth_input)
        custom_settings_fields_layout.addRow("Volume:", self.volume_max_trace_depth_input)
        custom_settings_fields_layout.addRow("Transparency:", self.transparency_max_trace_depth_input)
